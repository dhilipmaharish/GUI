...
def output_page(): 
    ...
    if request.method == "POST":       
        ...
        engine = request.form.get('engine_type')
        emission = request.form.get('emission_type')
        print(engine,emission)
